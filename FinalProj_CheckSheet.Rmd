...
(A) .Rmd Line number(s) for use of mulitple different geoms:  209, 216, 223

(B) .Rmd Line number(s) for use of multiple aesthetics:  209, 216, 223

(C) .Rmd Line number(s) for use of layered graphics:  209, 216, 223
